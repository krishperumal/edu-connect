...
<?php
	...
	{
		include("sql.php");
		$q="INSERT INTO profs (username,password,name,phone,email) VALUES('$_POST[username]','$_POST[password]','$_POST[name]','$_POST[phno]','$_POST[email]')";
		if(mysql_query($q,$con))
		{
			echo "New Prof account created<br/><br/>";
    ...
    echo '<form action="regprof.php" method="post" onsubmit="return validate()" >';
